          ...
          <div class="col-lg-12 col-md-12 col-sm-12">
            <div id="gallerySLide" class="gallery_area">
                <a href="img/gallery/img2.jpg" title="This is Title">
                  <img class="gallery_img" src="img/gallery/img2.jpg" alt="img" />
                <span class="view_btn">View</span>
                </a>
                <a href="img/gallery/img1.jpg" title="This is Title2">
                  <img class="gallery_img" src="img/gallery/img1.jpg" alt="img" />
                  <span class="view_btn">View</span>
                </a>
                <a href="img/gallery/img3.jpg" title="This is Title3">
                  <img class="gallery_img" src="img/gallery/img3.jpg" alt="img" />
                  <span class="view_btn">View</span>
                </a>
                <a href="img/gallery/img4.jpg" title="This is Title4">
                  <img class="gallery_img" src="img/gallery/img4.jpg" alt="img" />
                  <span class="view_btn">View</span>
                </a>
                <a href="img/gallery/img5.jpg" title="This is Title5">
                  <img class="gallery_img" src="img/gallery/img6.jpg" alt="img" />
                  <span class="view_btn">View</span>
                </a>
                <video width="320" height="240" controls auto>
