...
<body>
    <div id="wrapper">
        ...
        <tr><td > FOTO </td><td>
          <?php if($data['gambar'] ==  "")
          {
            echo "apabila tidak tampil silakan masukan foto";
          }
          else{
            echo "<img src='siswa/".$data['gambar']."'";
          }
          ?>
       ...
       <?php
              ...
              <br></br>
			<center><footer><p>All right reserved. Template by: <a href="http://webthemez.com">WebThemez</a></p></footer></center>
			</div>
             <!-- /. PAGE INNER  -->
            </div>
         <!-- /. PAGE WRAPPER  -->
